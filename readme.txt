Installation Requirements: Python3, python-docx module

Post installation of Python3 and python-docx, open a command terminal into the folder and run either of the following two:
1. python3 accept_letter.py
or
